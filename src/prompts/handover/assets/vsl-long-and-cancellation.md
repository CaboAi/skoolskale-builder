# Long VSL + Cancellation Video — framework (deliverable 02)

Two scripts in one file: (A) the long-form Video Sales Letter, (B) the cancellation/retention video. Both written **first person** for the creator to read to camera.

---

## A. LONG VSL SCRIPT (~3–5 min)

Fuller than the About-Us VSL — this is the primary sales video (used on a sales page, pinned post, or paid-tier upgrade page). Arc:

1. **Empathy open** — drop into the audience's inner experience. "Maybe you've felt this too…" Name the burning desire + the block.
...
Length control: this is longer than About-Us — expand phases 5–6 most. Use `[[PROOF: …]]` for any results claim.

---

## B. CANCELLATION / RETENTION VIDEO SCRIPT (~2–3 min)

Plays when a member clicks cancel. Goal: retain, or step them DOWN instead of OUT. Tone = understanding, never guilt-trippy, honest. Arc:

1. **Acknowledge + disarm** — "I see you're thinking about canceling. I get it. Life gets busy, money gets tight." No pressure.
...
## Output shape
```
# <Community> — VSL + Cancellation Video Scripts

## VSL Script (~3–5 min · first person)
…

## Cancellation Video Script (~2–3 min · first person)
…
```

Reference gold example: `templates/example-vsl-cancellation.md` (Laura's Story Medicine — note the three-tier walk, the founding-gift close, and the cancellation downgrade ladder).
